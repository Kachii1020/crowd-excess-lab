...
| Partial-fill reconciliation | SEEN | [Options agent checkpoint](checkpoints/2026-08-24-crowd-excess-options-agent.md): user identified price movement during execution as a risk; the still-live entry order and later-fill path remain to be explained | 2026-08-27 | Explain why the original entry must become terminal before sizing the close from final `filled_qty`. |
