...
| Partial-fill reconciliation | SEEN | [Options agent checkpoint](checkpoints/2026-08-24-crowd-excess-options-agent.md): requested and filled spread units are now separately recorded and tested | 2026-08-24 | Predict the safe action for a working 1-of-3 partial fill, then for the same order after cancellation. |
